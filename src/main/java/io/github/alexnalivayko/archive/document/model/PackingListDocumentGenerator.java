...
public class PackingListDocumentGenerator implements DocumentGenerator {

	private final DocumentService documentService;

	@Override
	public List<Document> findAll() {
		return documentService.getAllDocumentsByType(DocumentType.PACKING_LIST);
	}

	public PackingListDocumentGenerator(DocumentService documentService) {
